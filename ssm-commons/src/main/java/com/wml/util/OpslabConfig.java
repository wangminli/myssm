...
public class OpslabConfig {
    ...
    static {
        ...
        try (InputStream inputStream = contextClassLoader.getResource("0wml-default.properties").openStream()) {
            ...
            //获取非jar包内的配置信息
            try {
                String config_file = new File(contextClassLoader.getResource("0wml.properties").toURI()).getPath();
